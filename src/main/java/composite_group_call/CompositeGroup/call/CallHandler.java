...
package composite_group_call.CompositeGroup.call;
...
public class CallHandler extends TextWebSocketHandler
{
                                     ...
                                     TextMessage message) throws Exception
    {
        ...
        log.info("[CallHandler::handleTextMessage] message: {}, sessionId: {}");
                                       ...
                                       JsonObject jsonMessage)
    {
        ...
        final HubPort hubPort = new HubPort.Builder(composite).build();
    ...
    private void stop(final WebSocketSession session)
    {
        ...
        if (user != null) {
            HubPort hubport = user.getHubPort();
            if (hubport != null) {
                log.info("[HelloWorldHandler::stop] Release the ");
                hubport.release();
                log.info("number:{}", String.valueOf(composite.getChildren().size()));
            }
        }
    }
